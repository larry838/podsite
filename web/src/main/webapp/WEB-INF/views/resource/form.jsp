...
<link rel="stylesheet"
	href="${ctx }/resources/css/select2/select2.min.css" />
...
$(document).ready(function() {
	podsite.form.resource.initSourceType();
	podsite.form.resource.initSourceTree();
	podsite.form.resource.initIcon();
	podsite.form.resource.initType();
	podsite.form.resource.validateResourceForm();
});
</script>
<style>
.iconShow
...
<div class="center">
	...
	<button id="btn" type="button"
		onclick="podsite.common.loadPage('/resource/listUI.html<c:if test="${!empty resourceEntity}">?page=${page.pageNum }&rows=${page.pageSize }&sidx=${page.orderByColumn }&sord=${page.orderByType }</c:if>')"
