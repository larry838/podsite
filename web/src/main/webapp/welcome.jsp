...
<div class="row">
<p>
	podsite是基于<strong>RBAC</strong>的完全响应式管理系统,项目使用主流技术如下：
</p>
<p>
	<strong>服务端</strong>：
</p>
<p>
Spring4.3.0.RELEASE<br/>SpringMVC4.3.0.RELEASE<br/>Mybatis3.4<br/>Shiro1.2.6<br/>druid1.0.26<br/>ehcache2.6.11等
</p>
<p>
	<strong>前端</strong>：
</p>
