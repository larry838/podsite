...
$(function() {
    podsite.index.initHomePage();
    podsite.index.initNavigation();
    podsite.index.initScrollBar();
    podsite.index.menu.initDropdownMenuStyle();
    podsite.index.menu.initMenuEvent();
});
</script>
</head>
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a href="#" class="navbar-brand"> 
					<small> 
						<img src="${ctx }/resources/images/logo_no_title.png" height="25px"/> 布丁营销平台
					</small>
				</a>
		...
		<div class="footer">
			<div class="footer-inner">
				...
				<div class="footer-content">
					<span class="bigger-120"> <span class="blue bolder">住友酒店集团</span>
